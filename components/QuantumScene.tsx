...
// Fix for intrinsic JSX element errors in environments with missing Three.js global types
...
const MacroscopicWave = () => {
  ...
  return (
    <Torus ref={ref} args={[3, 0.1, 16, 100]} rotation={[Math.PI / 2, 0, 0]}>
      {/* Fix: Using uppercase MeshStandardMaterial constant to resolve JSX intrinsic error */}
  ...
  return (
    <div className="absolute inset-0 z-0 opacity-60 pointer-events-none">
      <Canvas camera={{ position: [0, 0, 6], fov: 45 }}>
        {/* Fix: Using uppercase light constants to resolve JSX intrinsic errors */}
    ...
    <div className="w-full h-full absolute inset-0">
      <Canvas camera={{ position: [0, 0, 4.5], fov: 45 }}>
        ...
        <Float rotationIntensity={0.4} floatIntensity={0.2} speed={1}>
          {/* Fix: Using uppercase Group constant to resolve JSX intrinsic error */}
